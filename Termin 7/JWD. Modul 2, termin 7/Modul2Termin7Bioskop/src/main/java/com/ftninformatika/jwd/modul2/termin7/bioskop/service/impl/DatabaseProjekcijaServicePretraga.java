...
@Service
@Validated
public class DatabaseProjekcijaServicePretraga implements ProjekcijaService {

	private final ProjekcijaDAO projekcijaDAO;
	private final FilmDAO filmDAO;
	private final ModelMapper mapper = new ModelMapper();

	public DatabaseProjekcijaServicePretraga(ProjekcijaDAO projekcijaDAO, FilmDAO filmDAO) {
